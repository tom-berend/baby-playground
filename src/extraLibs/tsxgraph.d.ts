...
type vertices3D = {
    [key: string]: number[] | Point3D | string;
};
...
```
*/
export type SpaceIcon = 'icons/alien-1.png' | 'icons/alien-2.png' | 'icons/alien-3.png' | 'icons/alien-4.png' | 'icons/alien-5.png' | 'icons/alien-abduction.png' | 'icons/alien-ship-2.png' | 'icons/alien-ship-beam.png' | 'icons/alien-ship.png' | 'icons/asteroid-2.png' | 'icons/asteroid.png' | 'icons/astronaut-helmet.png' | 'icons/atom.png' | 'icons/astronaut.png' | 'icons/bb-8.png' | 'icons/big-dipper.png' | 'icons/black-hole.png' | 'icons/brain-slug.png' | 'icons/cassiopeia.png' | 'icons/chewbacca.png' | 'icons/comet.png' | 'icons/cylon-raider.png' | 'icons/darth-vader.png' | 'icons/death-star.png' | 'icons/earth.png' | 'icons/falling-asteroid.png' | 'icons/falling-space-capsule.png' | 'icons/falling-star.png' | 'icons/flag.png' | 'icons/fly\ icon\ licence.png' | 'icons/flyicon.png' | 'icons/galaxy.png' | 'icons/intl-space-station.png' | 'icons/jupiter.png' | 'icons/landing-space-capsule.png' | 'icons/laser-gun.png' | 'icons/mars.png' | 'icons/millennium-falcon.png' | 'icons/mission-control.png' | 'icons/moon-full-almost.png' | 'icons/moon-full-moon.png' | 'icons/moon-last-quarter.png' | 'icons/moon-new-moon.png' | 'icons/moon-waning-cresent.png' | 'icons/moon-waning-gibbous.png' | 'icons/morty.png' | 'icons/neptune.png' | 'icons/pluto.png' | 'icons/princess-leia.png' | 'icons/rick.png' | 'icons/ring-ship.png' | 'icons/rocket-launch.png' | 'icons/rocket.png' | 'icons/satellite.png' | 'icons/saturn.png' | 'icons/solar-system.png' | 'icons/space-capsule.png' | 'icons/space-cockpit.png' | 'icons/space-invader.png' | 'icons/space-observatory.png' | 'icons/space-rocket.png' | 'icons/space-rover-1.png' | 'icons/space-rover-2.png' | 'icons/space-satellite-dish.png' | 'icons/space-ship_1.png' | 'icons/space-ship_2.png' | 'icons/space-ship_3.png' | 'icons/space-ship.png' | 'icons/space-shuttle-launch.png' | 'icons/space-shuttle.png' | 'icons/sputnick-1.png' | 'icons/sputnick-2.png' | 'icons/star.png' | 'icons/stars.png' | 'icons/stormtrooper.png' | 'icons/sun.png' | 'icons/telescope.png' | 'icons/uranus.png' | 'icons/venus.png' | 'icons/moon-dreamy.png';
export type Sounds = 'Alien/sfx_deathscream_alien1.wav' | 'Alien/sfx_deathscream_alien2.wav' | 'Alien/sfx_deathscream_alien3.wav' | 'Alien/sfx_deathscream_alien4.wav' | 'Alien/sfx_deathscream_alien5.wav' | 'Alien/sfx_deathscream_alien6.wav' | 'Android/sfx_deathscream_android1.wav' | 'Android/sfx_deathscream_android2.wav' | 'Android/sfx_deathscream_android3.wav' | 'Android/sfx_deathscream_android4.wav' | 'Android/sfx_deathscream_android5.wav' | 'Android/sfx_deathscream_android6.wav' | 'Android/sfx_deathscream_android7.wav' | 'Android/sfx_deathscream_android8.wav' | 'Human/sfx_deathscream_human1.wav' | 'Human/sfx_deathscream_human10.wav' | 'Human/sfx_deathscream_human11.wav' | 'Human/sfx_deathscream_human12.wav' | 'Human/sfx_deathscream_human13.wav' | 'Human/sfx_deathscream_human14.wav' | 'Human/sfx_deathscream_human2.wav' | 'Human/sfx_deathscream_human3.wav' | 'Human/sfx_deathscream_human4.wav' | 'Human/sfx_deathscream_human5.wav' | 'Human/sfx_deathscream_human6.wav' | 'Human/sfx_deathscream_human7.wav' | 'Human/sfx_deathscream_human8.wav' | 'Human/sfx_deathscream_human9.wav' | 'Robot/sfx_deathscream_robot1.wav' | 'Robot/sfx_deathscream_robot2.wav' | 'Robot/sfx_deathscream_robot3.wav' | 'Robot/sfx_deathscream_robot4.wav' | 'Clusters/sfx_exp_cluster1.wav' | 'Clusters/sfx_exp_cluster10.wav' | 'Clusters/sfx_exp_cluster11.wav' | 'Clusters/sfx_exp_cluster2.wav' | 'Clusters/sfx_exp_cluster3.wav' | 'Clusters/sfx_exp_cluster4.wav' | 'Clusters/sfx_exp_cluster5.wav' | 'Clusters/sfx_exp_cluster6.wav' | 'Clusters/sfx_exp_cluster7.wav' | 'Clusters/sfx_exp_cluster8.wav' | 'Clusters/sfx_exp_cluster9.wav' | 'Double/sfx_exp_double1.wav' | 'Double/sfx_exp_double2.wav' | 'Double/sfx_exp_double3.wav' | 'Long/sfx_exp_long1.wav' | 'Long/sfx_exp_long2.wav' | 'Long/sfx_exp_long3.wav' | 'Long/sfx_exp_long4.wav' | 'Long/sfx_exp_long5.wav' | 'Long/sfx_exp_long6.wav' | 'Medium Length/sfx_exp_medium1.wav' | 'Medium Length/sfx_exp_medium10.wav' | 'Medium Length/sfx_exp_medium11.wav' | 'Medium Length/sfx_exp_medium12.wav' | 'Medium Length/sfx_exp_medium13.wav' | 'Medium Length/sfx_exp_medium2.wav' | 'Medium Length/sfx_exp_medium3.wav' | 'Medium Length/sfx_exp_medium4.wav' | 'Medium Length/sfx_exp_medium5.wav' | 'Medium Length/sfx_exp_medium6.wav' | 'Medium Length/sfx_exp_medium7.wav' | 'Medium Length/sfx_exp_medium8.wav' | 'Medium Length/sfx_exp_medium9.wav' | 'Odd/sfx_exp_odd1.wav' | 'Odd/sfx_exp_odd2.wav' | 'Odd/sfx_exp_odd3.wav' | 'Odd/sfx_exp_odd4.wav' | 'Odd/sfx_exp_odd5.wav' | 'Odd/sfx_exp_odd6.wav' | 'Odd/sfx_exp_odd7.wav' | 'Short/sfx_exp_short_hard1.wav' | 'Short/sfx_exp_short_hard10.wav' | 'Short/sfx_exp_short_hard11.wav' | 'Short/sfx_exp_short_hard12.wav' | 'Short/sfx_exp_short_hard13.wav' | 'Short/sfx_exp_short_hard14.wav' | 'Short/sfx_exp_short_hard15.wav' | 'Short/sfx_exp_short_hard16.wav' | 'Short/sfx_exp_short_hard17.wav' | 'Short/sfx_exp_short_hard2.wav' | 'Short/sfx_exp_short_hard3.wav' | 'Short/sfx_exp_short_hard4.wav' | 'Short/sfx_exp_short_hard5.wav' | 'Short/sfx_exp_short_hard6.wav' | 'Short/sfx_exp_short_hard7.wav' | 'Short/sfx_exp_short_hard8.wav' | 'Short/sfx_exp_short_hard9.wav' | 'Short/sfx_exp_short_soft1.wav' | 'Short/sfx_exp_short_soft10.wav' | 'Short/sfx_exp_short_soft11.wav' | 'Short/sfx_exp_short_soft12.wav' | 'Short/sfx_exp_short_soft2.wav' | 'Short/sfx_exp_short_soft3.wav' | 'Short/sfx_exp_short_soft4.wav' | 'Short/sfx_exp_short_soft5.wav' | 'Short/sfx_exp_short_soft6.wav' | 'Short/sfx_exp_short_soft7.wav' | 'Short/sfx_exp_short_soft8.wav' | 'Short/sfx_exp_short_soft9.wav' | 'Shortest/sfx_exp_shortest_hard1.wav' | 'Shortest/sfx_exp_shortest_hard10.wav' | 'Shortest/sfx_exp_shortest_hard2.wav' | 'Shortest/sfx_exp_shortest_hard3.wav' | 'Shortest/sfx_exp_shortest_hard4.wav' | 'Shortest/sfx_exp_shortest_hard5.wav' | 'Shortest/sfx_exp_shortest_hard6.wav' | 'Shortest/sfx_exp_shortest_hard7.wav' | 'Shortest/sfx_exp_shortest_hard8.wav' | 'Shortest/sfx_exp_shortest_hard9.wav' | 'Shortest/sfx_exp_shortest_soft1.wav' | 'Shortest/sfx_exp_shortest_soft2.wav' | 'Shortest/sfx_exp_shortest_soft3.wav' | 'Shortest/sfx_exp_shortest_soft4.wav' | 'Shortest/sfx_exp_shortest_soft5.wav' | 'Shortest/sfx_exp_shortest_soft6.wav' | 'Shortest/sfx_exp_shortest_soft7.wav' | 'Shortest/sfx_exp_shortest_soft8.wav' | 'Shortest/sfx_exp_shortest_soft9.wav' | 'Various/sfx_exp_various1.wav' | 'Various/sfx_exp_various2.wav' | 'Various/sfx_exp_various3.wav' | 'Various/sfx_exp_various4.wav' | 'Various/sfx_exp_various5.wav' | 'Various/sfx_exp_various6.wav' | 'Various/sfx_exp_various7.wav' | 'Alarms/Alarms/sfx_alarm_loop1.wav' | 'Alarms/Alarms/sfx_alarm_loop2.wav' | 'Alarms/Alarms/sfx_alarm_loop3.wav' | 'Alarms/Alarms/sfx_alarm_loop4.wav' | 'Alarms/Alarms/sfx_alarm_loop5.wav' | 'Alarms/Alarms/sfx_alarm_loop6.wav' | 'Alarms/Alarms/sfx_alarm_loop7.wav' | 'Alarms/Alarms/sfx_alarm_loop8.wav' | 'Alarms/Lowhealth/sfx_lowhealth_alarmloop1.wav' | 'Alarms/Lowhealth/sfx_lowhealth_alarmloop2.wav' | 'Alarms/Lowhealth/sfx_lowhealth_alarmloop3.wav' | 'Alarms/Lowhealth/sfx_lowhealth_alarmloop4.wav' | 'Alarms/Lowhealth/sfx_lowhealth_alarmloop5.wav' | 'Alarms/Lowhealth/sfx_lowhealth_alarmloop6.wav' | 'Alarms/Lowhealth/sfx_lowhealth_alarmloop7.wav' | 'Buttons/sfx_sounds_button1.wav' | 'Buttons/sfx_sounds_button10.wav' | 'Buttons/sfx_sounds_button11.wav' | 'Buttons/sfx_sounds_button12.wav' | 'Buttons/sfx_sounds_button13.wav' | 'Buttons/sfx_sounds_button14.wav' | 'Buttons/sfx_sounds_button2.wav' | 'Buttons/sfx_sounds_button3.wav' | 'Buttons/sfx_sounds_button4.wav' | 'Buttons/sfx_sounds_button5.wav' | 'Buttons/sfx_sounds_button6.wav' | 'Buttons/sfx_sounds_button7.wav' | 'Buttons/sfx_sounds_button8.wav' | 'Buttons/sfx_sounds_button9.wav' | 'Coins/sfx_coin_cluster1.wav' | 'Coins/sfx_coin_cluster2.wav' | 'Coins/sfx_coin_cluster3.wav' | 'Coins/sfx_coin_cluster4.wav' | 'Coins/sfx_coin_cluster5.wav' | 'Coins/sfx_coin_cluster6.wav' | 'Coins/sfx_coin_cluster7.wav' | 'Coins/sfx_coin_cluster8.wav' | 'Coins/sfx_coin_cluster9.wav' | 'Coins/sfx_coin_double1.wav' | 'Coins/sfx_coin_double2.wav' | 'Coins/sfx_coin_double3.wav' | 'Coins/sfx_coin_double4.wav' | 'Coins/sfx_coin_double5.wav' | 'Coins/sfx_coin_double6.wav' | 'Coins/sfx_coin_double7.wav' | 'Coins/sfx_coin_single1.wav' | 'Coins/sfx_coin_single2.wav' | 'Coins/sfx_coin_single3.wav' | 'Coins/sfx_coin_single4.wav' | 'Coins/sfx_coin_single5.wav' | 'Coins/sfx_coin_single6.wav' | 'Fanfares/sfx_sounds_fanfare1.wav' | 'Fanfares/sfx_sounds_fanfare2.wav' | 'Fanfares/sfx_sounds_fanfare3.wav' | 'High Pitched Sounds/sfx_sounds_high1.wav' | 'High Pitched Sounds/sfx_sounds_high2.wav' | 'High Pitched Sounds/sfx_sounds_high3.wav' | 'High Pitched Sounds/sfx_sounds_high4.wav' | 'High Pitched Sounds/sfx_sounds_high5.wav' | 'High Pitched Sounds/sfx_sounds_high6.wav' | 'High Pitched Sounds/sfx_sounds_high7.wav' | 'Impacts/sfx_sounds_impact1.wav' | 'Impacts/sfx_sounds_impact10.wav' | 'Impacts/sfx_sounds_impact11.wav' | 'Impacts/sfx_sounds_impact12.wav' | 'Impacts/sfx_sounds_impact13.wav' | 'Impacts/sfx_sounds_impact14.wav' | 'Impacts/sfx_sounds_impact15.wav' | 'Impacts/sfx_sounds_impact2.wav' | 'Impacts/sfx_sounds_impact3.wav' | 'Impacts/sfx_sounds_impact4.wav' | 'Impacts/sfx_sounds_impact5.wav' | 'Impacts/sfx_sounds_impact6.wav' | 'Impacts/sfx_sounds_impact7.wav' | 'Impacts/sfx_sounds_impact8.wav' | 'Impacts/sfx_sounds_impact9.wav' | 'Interactions/sfx_sounds_interaction1.wav' | 'Interactions/sfx_sounds_interaction10.wav' | 'Interactions/sfx_sounds_interaction11.wav' | 'Interactions/sfx_sounds_interaction12.wav' | 'Interactions/sfx_sounds_interaction13.wav' | 'Interactions/sfx_sounds_interaction14.wav' | 'Interactions/sfx_sounds_interaction15.wav' | 'Interactions/sfx_sounds_interaction16.wav' | 'Interactions/sfx_sounds_interaction17.wav' | 'Interactions/sfx_sounds_interaction18.wav' | 'Interactions/sfx_sounds_interaction19.wav' | 'Interactions/sfx_sounds_interaction2.wav' | 'Interactions/sfx_sounds_interaction20.wav' | 'Interactions/sfx_sounds_interaction21.wav' | 'Interactions/sfx_sounds_interaction22.wav' | 'Interactions/sfx_sounds_interaction23.wav' | 'Interactions/sfx_sounds_interaction24.wav' | 'Interactions/sfx_sounds_interaction25.wav' | 'Interactions/sfx_sounds_interaction26.wav' | 'Interactions/sfx_sounds_interaction3.wav' | 'Interactions/sfx_sounds_interaction4.wav' | 'Interactions/sfx_sounds_interaction5.wav' | 'Interactions/sfx_sounds_interaction6.wav' | 'Interactions/sfx_sounds_interaction7.wav' | 'Interactions/sfx_sounds_interaction8.wav' | 'Interactions/sfx_sounds_interaction9.wav' | 'Menu Sounds/sfx_menu_move1.wav' | 'Menu Sounds/sfx_menu_move2.wav' | 'Menu Sounds/sfx_menu_move3.wav' | 'Menu Sounds/sfx_menu_move4.wav' | 'Menu Sounds/sfx_menu_move5.wav' | 'Menu Sounds/sfx_menu_select1.wav' | 'Menu Sounds/sfx_menu_select2.wav' | 'Menu Sounds/sfx_menu_select3.wav' | 'Menu Sounds/sfx_menu_select4.wav' | 'Menu Sounds/sfx_menu_select5.wav' | 'Negative Sounds/sfx_sounds_damage1.wav' | 'Negative Sounds/sfx_sounds_damage2.wav' | 'Negative Sounds/sfx_sounds_damage3.wav' | 'Negative Sounds/sfx_sounds_error1.wav' | 'Negative Sounds/sfx_sounds_error10.wav' | 'Negative Sounds/sfx_sounds_error11.wav' | 'Negative Sounds/sfx_sounds_error12.wav' | 'Negative Sounds/sfx_sounds_error13.wav' | 'Negative Sounds/sfx_sounds_error14.wav' | 'Negative Sounds/sfx_sounds_error15.wav' | 'Negative Sounds/sfx_sounds_error2.wav' | 'Negative Sounds/sfx_sounds_error3.wav' | 'Negative Sounds/sfx_sounds_error4.wav' | 'Negative Sounds/sfx_sounds_error5.wav' | 'Negative Sounds/sfx_sounds_error6.wav' | 'Negative Sounds/sfx_sounds_error7.wav' | 'Negative Sounds/sfx_sounds_error8.wav' | 'Negative Sounds/sfx_sounds_error9.wav' | 'Negative Sounds/sfx_sounds_negative1.wav' | 'Negative Sounds/sfx_sounds_negative2.wav' | 'Neutral Sounds/sfx_sound_neutral1.wav' | 'Neutral Sounds/sfx_sound_neutral10.wav' | 'Neutral Sounds/sfx_sound_neutral11.wav' | 'Neutral Sounds/sfx_sound_neutral2.wav' | 'Neutral Sounds/sfx_sound_neutral3.wav' | 'Neutral Sounds/sfx_sound_neutral4.wav' | 'Neutral Sounds/sfx_sound_neutral5.wav' | 'Neutral Sounds/sfx_sound_neutral6.wav' | 'Neutral Sounds/sfx_sound_neutral7.wav' | 'Neutral Sounds/sfx_sound_neutral8.wav' | 'Neutral Sounds/sfx_sound_neutral9.wav' | 'Pause Sounds/sfx_sounds_pause1_in.wav' | 'Pause Sounds/sfx_sounds_pause1_out.wav' | 'Pause Sounds/sfx_sounds_pause2_in.wav' | 'Pause Sounds/sfx_sounds_pause2_out.wav' | 'Pause Sounds/sfx_sounds_pause3_in.wav' | 'Pause Sounds/sfx_sounds_pause3_out.wav' | 'Pause Sounds/sfx_sounds_pause4_in.wav' | 'Pause Sounds/sfx_sounds_pause4_out.wav' | 'Pause Sounds/sfx_sounds_pause5_in.wav' | 'Pause Sounds/sfx_sounds_pause5_out.wav' | 'Pause Sounds/sfx_sounds_pause6_in.wav' | 'Pause Sounds/sfx_sounds_pause6_out.wav' | 'Pause Sounds/sfx_sounds_pause7_in.wav' | 'Pause Sounds/sfx_sounds_pause7_out.wav' | 'Positive Sounds/sfx_sounds_powerup1.wav' | 'Positive Sounds/sfx_sounds_powerup10.wav' | 'Positive Sounds/sfx_sounds_powerup11.wav' | 'Positive Sounds/sfx_sounds_powerup12.wav' | 'Positive Sounds/sfx_sounds_powerup13.wav' | 'Positive Sounds/sfx_sounds_powerup14.wav' | 'Positive Sounds/sfx_sounds_powerup15.wav' | 'Positive Sounds/sfx_sounds_powerup16.wav' | 'Positive Sounds/sfx_sounds_powerup17.wav' | 'Positive Sounds/sfx_sounds_powerup18.wav' | 'Positive Sounds/sfx_sounds_powerup2.wav' | 'Positive Sounds/sfx_sounds_powerup3.wav' | 'Positive Sounds/sfx_sounds_powerup4.wav' | 'Positive Sounds/sfx_sounds_powerup5.wav' | 'Positive Sounds/sfx_sounds_powerup6.wav' | 'Positive Sounds/sfx_sounds_powerup7.wav' | 'Positive Sounds/sfx_sounds_powerup8.wav' | 'Positive Sounds/sfx_sounds_powerup9.wav' | 'Simple Bleeps/sfx_sounds_Blip1.wav' | 'Simple Bleeps/sfx_sounds_Blip10.wav' | 'Simple Bleeps/sfx_sounds_Blip11.wav' | 'Simple Bleeps/sfx_sounds_Blip2.wav' | 'Simple Bleeps/sfx_sounds_Blip3.wav' | 'Simple Bleeps/sfx_sounds_Blip4.wav' | 'Simple Bleeps/sfx_sounds_Blip5.wav' | 'Simple Bleeps/sfx_sounds_Blip6.wav' | 'Simple Bleeps/sfx_sounds_Blip7.wav' | 'Simple Bleeps/sfx_sounds_Blip8.wav' | 'Simple Bleeps/sfx_sounds_Blip9.wav' | 'Simple Damage Sounds/sfx_damage_hit1.wav' | 'Simple Damage Sounds/sfx_damage_hit10.wav' | 'Simple Damage Sounds/sfx_damage_hit2.wav' | 'Simple Damage Sounds/sfx_damage_hit3.wav' | 'Simple Damage Sounds/sfx_damage_hit4.wav' | 'Simple Damage Sounds/sfx_damage_hit5.wav' | 'Simple Damage Sounds/sfx_damage_hit6.wav' | 'Simple Damage Sounds/sfx_damage_hit7.wav' | 'Simple Damage Sounds/sfx_damage_hit8.wav' | 'Simple Damage Sounds/sfx_damage_hit9.wav' | 'Weird Sounds/sfx_sound_bling.wav' | 'Weird Sounds/sfx_sound_depressurizing.wav' | 'Weird Sounds/sfx_sound_mechanicalnoise1.wav' | 'Weird Sounds/sfx_sound_mechanicalnoise2.wav' | 'Weird Sounds/sfx_sound_mechanicalnoise3.wav' | 'Weird Sounds/sfx_sound_mechanicalnoise4.wav' | 'Weird Sounds/sfx_sound_mechanicalnoise5.wav' | 'Weird Sounds/sfx_sound_mechanicalnoise6.wav' | 'Weird Sounds/sfx_sound_nagger1.wav' | 'Weird Sounds/sfx_sound_nagger2.wav' | 'Weird Sounds/sfx_sound_noise.wav' | 'Weird Sounds/sfx_sound_poweron.wav' | 'Weird Sounds/sfx_sound_refereewhistle.wav' | 'Weird Sounds/sfx_sound_shutdown1.wav' | 'Weird Sounds/sfx_sound_shutdown2.wav' | 'Weird Sounds/sfx_sound_vaporizing.wav' | 'Climbing Ladder/sfx_movement_ladder1a.wav' | 'Climbing Ladder/sfx_movement_ladder1b.wav' | 'Climbing Ladder/sfx_movement_ladder1loop.wav' | 'Climbing Ladder/sfx_movement_ladder2a.wav' | 'Climbing Ladder/sfx_movement_ladder2b.wav' | 'Climbing Ladder/sfx_movement_ladder2loop.wav' | 'Climbing Ladder/sfx_movement_ladder3a.wav' | 'Climbing Ladder/sfx_movement_ladder3b.wav' | 'Climbing Ladder/sfx_movement_ladder3loop.wav' | 'Climbing Ladder/sfx_movement_ladder4a.wav' | 'Climbing Ladder/sfx_movement_ladder4b.wav' | 'Climbing Ladder/sfx_movement_ladder4loop.wav' | 'Climbing Ladder/sfx_movement_ladder5a.wav' | 'Climbing Ladder/sfx_movement_ladder5b.wav' | 'Climbing Ladder/sfx_movement_ladder5loop.wav' | 'Climbing Ladder/sfx_movement_ladder6a.wav' | 'Climbing Ladder/sfx_movement_ladder6b.wav' | 'Climbing Ladder/sfx_movement_ladder6loop.wav' | 'Climbing Stairs/sfx_movement_stairs1a.wav' | 'Climbing Stairs/sfx_movement_stairs1b.wav' | 'Climbing Stairs/sfx_movement_stairs1loop.wav' | 'Climbing Stairs/sfx_movement_stairs2a.wav' | 'Climbing Stairs/sfx_movement_stairs2b.wav' | 'Climbing Stairs/sfx_movement_stairs2loop.wav' | 'Climbing Stairs/sfx_movement_stairs3a.wav' | 'Climbing Stairs/sfx_movement_stairs3b.wav' | 'Climbing Stairs/sfx_movement_stairs3loop.wav' | 'Climbing Stairs/sfx_movement_stairs4a.wav' | 'Climbing Stairs/sfx_movement_stairs4b.wav' | 'Climbing Stairs/sfx_movement_stairs4loop.wav' | 'Climbing Stairs/sfx_movement_stairs5a.wav' | 'Climbing Stairs/sfx_movement_stairs5b.wav' | 'Climbing Stairs/sfx_movement_stairs5loop.wav' | 'Climbing Stairs/sfx_movement_stairs6a.wav' | 'Climbing Stairs/sfx_movement_stairs6b.wav' | 'Climbing Stairs/sfx_movement_stairs6loop.wav' | 'Falling Sounds/sfx_sounds_falling1.wav' | 'Falling Sounds/sfx_sounds_falling10.wav' | 'Falling Sounds/sfx_sounds_falling11.wav' | 'Falling Sounds/sfx_sounds_falling12.wav' | 'Falling Sounds/sfx_sounds_falling2.wav' | 'Falling Sounds/sfx_sounds_falling3.wav' | 'Falling Sounds/sfx_sounds_falling4.wav' | 'Falling Sounds/sfx_sounds_falling5.wav' | 'Falling Sounds/sfx_sounds_falling6.wav' | 'Falling Sounds/sfx_sounds_falling7.wav' | 'Falling Sounds/sfx_sounds_falling8.wav' | 'Falling Sounds/sfx_sounds_falling9.wav' | 'Footsteps/sfx_movement_footsteps1a.wav' | 'Footsteps/sfx_movement_footsteps1b.wav' | 'Footsteps/sfx_movement_footsteps5.wav' | 'Footsteps/sfx_movement_footstepsloop3_fast.wav' | 'Footsteps/sfx_movement_footstepsloop3_slow.wav' | 'Footsteps/sfx_movement_footstepsloop4_fast.wav' | 'Footsteps/sfx_movement_footstepsloop4_slow.wav' | 'Jumping and Landing/sfx_movement_jump1.wav' | 'Jumping and Landing/sfx_movement_jump10.wav' | 'Jumping and Landing/sfx_movement_jump10_landing.wav' | 'Jumping and Landing/sfx_movement_jump11.wav' | 'Jumping and Landing/sfx_movement_jump11_landing.wav' | 'Jumping and Landing/sfx_movement_jump12.wav' | 'Jumping and Landing/sfx_movement_jump12_landing.wav' | 'Jumping and Landing/sfx_movement_jump13.wav' | 'Jumping and Landing/sfx_movement_jump13_landing.wav' | 'Jumping and Landing/sfx_movement_jump14.wav' | 'Jumping and Landing/sfx_movement_jump14_landing.wav' | 'Jumping and Landing/sfx_movement_jump15.wav' | 'Jumping and Landing/sfx_movement_jump15_landing.wav' | 'Jumping and Landing/sfx_movement_jump16.wav' | 'Jumping and Landing/sfx_movement_jump16_landing.wav' | 'Jumping and Landing/sfx_movement_jump17.wav' | 'Jumping and Landing/sfx_movement_jump17_landing.wav' | 'Jumping and Landing/sfx_movement_jump18.wav' | 'Jumping and Landing/sfx_movement_jump18_landing.wav' | 'Jumping and Landing/sfx_movement_jump19.wav' | 'Jumping and Landing/sfx_movement_jump19_landing.wav' | 'Jumping and Landing/sfx_movement_jump2.wav' | 'Jumping and Landing/sfx_movement_jump20.wav' | 'Jumping and Landing/sfx_movement_jump3.wav' | 'Jumping and Landing/sfx_movement_jump4.wav' | 'Jumping and Landing/sfx_movement_jump5.wav' | 'Jumping and Landing/sfx_movement_jump6.wav' | 'Jumping and Landing/sfx_movement_jump7.wav' | 'Jumping and Landing/sfx_movement_jump8.wav' | 'Jumping and Landing/sfx_movement_jump9.wav' | 'Jumping and Landing/sfx_movement_jump9_landing.wav' | 'Opening Doors/sfx_movement_dooropen1.wav' | 'Opening Doors/sfx_movement_dooropen2.wav' | 'Opening Doors/sfx_movement_dooropen3.wav' | 'Opening Doors/sfx_movement_dooropen4.wav' | 'Portals and Transitions/sfx_movement_portal1.wav' | 'Portals and Transitions/sfx_movement_portal2.wav' | 'Portals and Transitions/sfx_movement_portal3.wav' | 'Portals and Transitions/sfx_movement_portal4.wav' | 'Portals and Transitions/sfx_movement_portal5.wav' | 'Portals and Transitions/sfx_movement_portal6.wav' | 'Vehicles/sfx_vehicle_breaks.wav' | 'Vehicles/sfx_vehicle_carloop1.wav' | 'Vehicles/sfx_vehicle_carloop2.wav' | 'Vehicles/sfx_vehicle_engineloop.wav' | 'Vehicles/sfx_vehicle_helicopterloop1.wav' | 'Vehicles/sfx_vehicle_helicopterloop2.wav' | 'Vehicles/sfx_vehicle_helicopterloop3.wav' | 'Vehicles/sfx_vehicle_helicopterloop4.wav' | 'Vehicles/sfx_vehicle_plainloop.wav' | 'Cannon/sfx_wpn_cannon1.wav' | 'Cannon/sfx_wpn_cannon2.wav' | 'Cannon/sfx_wpn_cannon3.wav' | 'Cannon/sfx_wpn_cannon4.wav' | 'Cannon/sfx_wpn_cannon5.wav' | 'Cannon/sfx_wpn_cannon6.wav' | 'Grenade Whistles/sfx_wpn_grenadewhistle1.wav' | 'Grenade Whistles/sfx_wpn_grenadewhistle2.wav' | 'Grenade Whistles/sfx_wpn_missilelaunch.wav' | 'Lasers/sfx_wpn_laser 10.wav' | 'Lasers/sfx_wpn_laser1.wav' | 'Lasers/sfx_wpn_laser10.wav' | 'Lasers/sfx_wpn_laser11.wav' | 'Lasers/sfx_wpn_laser12.wav' | 'Lasers/sfx_wpn_laser2.wav' | 'Lasers/sfx_wpn_laser3.wav' | 'Lasers/sfx_wpn_laser4.wav' | 'Lasers/sfx_wpn_laser5.wav' | 'Lasers/sfx_wpn_laser6.wav' | 'Lasers/sfx_wpn_laser7.wav' | 'Lasers/sfx_wpn_laser8.wav' | 'Lasers/sfx_wpn_laser9.wav' | 'Machinegun/sfx_wpn_machinegun_loop1.wav' | 'Machinegun/sfx_wpn_machinegun_loop2.wav' | 'Machinegun/sfx_wpn_machinegun_loop3.wav' | 'Machinegun/sfx_wpn_machinegun_loop4.wav' | 'Machinegun/sfx_wpn_machinegun_loop5.wav' | 'Machinegun/sfx_wpn_machinegun_loop6.wav' | 'Machinegun/sfx_wpn_machinegun_loop7.wav' | 'Machinegun/sfx_wpn_machinegun_loop8.wav' | 'Machinegun/sfx_wpn_machinegun_loop9.wav' | 'Melee/sfx_wpn_dagger.wav' | 'Melee/sfx_wpn_punch1.wav' | 'Melee/sfx_wpn_punch2.wav' | 'Melee/sfx_wpn_punch3.wav' | 'Melee/sfx_wpn_punch4.wav' | 'Melee/sfx_wpn_sword1.wav' | 'Melee/sfx_wpn_sword2.wav' | 'Melee/sfx_wpn_sword3.wav' | 'Out of Ammo/sfx_wpn_noammo1.wav' | 'Out of Ammo/sfx_wpn_noammo2.wav' | 'Out of Ammo/sfx_wpn_noammo3.wav' | 'Out of Ammo/sfx_wpn_reload.wav' | 'Shotgun/sfx_weapon_shotgun1.wav' | 'Shotgun/sfx_weapon_shotgun2.wav' | 'Shotgun/sfx_weapon_shotgun3.wav' | 'Single Shot Sounds/sfx_weapon_singleshot1.wav' | 'Single Shot Sounds/sfx_weapon_singleshot10.wav' | 'Single Shot Sounds/sfx_weapon_singleshot11.wav' | 'Single Shot Sounds/sfx_weapon_singleshot12.wav' | 'Single Shot Sounds/sfx_weapon_singleshot13.wav' | 'Single Shot Sounds/sfx_weapon_singleshot14.wav' | 'Single Shot Sounds/sfx_weapon_singleshot15.wav' | 'Single Shot Sounds/sfx_weapon_singleshot16.wav' | 'Single Shot Sounds/sfx_weapon_singleshot17.wav' | 'Single Shot Sounds/sfx_weapon_singleshot18.wav' | 'Single Shot Sounds/sfx_weapon_singleshot19.wav' | 'Single Shot Sounds/sfx_weapon_singleshot2.wav' | 'Single Shot Sounds/sfx_weapon_singleshot20.wav' | 'Single Shot Sounds/sfx_weapon_singleshot21.wav' | 'Single Shot Sounds/sfx_weapon_singleshot22.wav' | 'Single Shot Sounds/sfx_weapon_singleshot3.wav' | 'Single Shot Sounds/sfx_weapon_singleshot4.wav' | 'Single Shot Sounds/sfx_weapon_singleshot5.wav' | 'Single Shot Sounds/sfx_weapon_singleshot6.wav' | 'Single Shot Sounds/sfx_weapon_singleshot7.wav' | 'Single Shot Sounds/sfx_weapon_singleshot8.wav' | 'Single Shot Sounds/sfx_weapon_singleshot9.wav';
...
export interface GeometryElement extends Events {
    ...
    descendants: Object;
    /** The element is saved with an explicit entry in the file (<tt>true</tt>) or implicitly via a composition. */
    dump: Boolean;
    /** The element's class. */
    elementClass: Number;
    ...
    id: String;
    /** Inherits contains the subelements, which may have an attribute (in particular the attribute  */
    inherits: Object;
    ...
    /** Stores the SVG (or VML) rendering node for the element. This enables low-level access to SVG nodes. The properties of such an SVG node can then be changed by calling setAttribute(). Note that there are a few elements which consist of more than one SVG nodes: <ul> <li> Elements with arrow tail or head: rendNodeTriangleStart, rendNodeTriangleEnd <li> SVG (or VML) texts: rendNodeText <li> Button: rendNodeForm, rendNodeButton, rendNodeTag <li> Checkbox: rendNodeForm, rendNodeCheckbox, rendNodeLabel, rendNodeTag <li> Input: rendNodeForm, rendNodeInput, rendNodeLabel, rendNodeTag </ul> Here is are two examples: The first example shows how to access the SVG node, the second example demonstrates how to change SVG attributes. */
    rendNode: HTMLElement;
    /** [c, b0, b1, a, k, r, q0, q1] See A.E. Middleditch, T.W. Stacey, and S.B. Tor:  */
    stdform: number[];
...
export interface CoordsElement extends Omit<GeometryElement, 'snapToPoints'> {
    ...
    /** A {@link JXG.CoordsElement#updateGlider} call is usually followed by a general {@link JXG.Board#update} which calls {@link JXG.CoordsElement#updateGliderFromParent}. To prevent double updates, {@link JXG.CoordsElement#needsUpdateFromParent} is set to false in updateGlider() and reset to true in the following call to {@link JXG.CoordsElement#updateGliderFromParent} */
    ...
    position: number;
    /** When used as a glider this member stores the object, where to glide on. To set the object to glide on use the method {@link JXG.Point#makeGlider} and DO NOT set this property directly as it will break the dependency tree. */
    slideObject: GeometryElement;
    /** List of elements the element is bound to, i.e. the element glides on. Only the last entry is active. Use {@link JXG.Point#popSlideObject} to remove the currently active slideObject. */
...
export interface Line extends Omit<GeometryElement, 'addTransform'> {
    ...
    /** Startpoint of the line. You really should not set this field directly as it may break JSXGraph&#039;s update system so your construction won&#039;t be updated properly. */
    point1: Point;
    /** Endpoint of the line. Just like {@link JXG.Line.point1} you shouldn&#039;t write this field directly. */
    point2: Point;
    /** Array of ticks storing all the ticks on this line. Do not set this field directly and use {@link JXG.Line#addTicks} and {@link JXG.Line#removeTicks} to add and remove ticks to and from the line. */
    ticks: number[];
...
export interface View3D extends Omit<GeometryElement, 'create'> {
    ...
    bbox3D: number[][];
    /** The 4×4 matrix that maps box coordinates to camera coordinates. These coordinate systems fit into the View3D coordinate atlas as follows. <ul> <li><b>World coordinates.</b> The coordinates used to specify object positions in a JSXGraph scene.</li> <li><b>Box coordinates.</b> The world coordinates translated to put the center of the view box at the origin. <li><b>Camera coordinates.</b> The coordinate system where the <code>x</code>, <code>y</code> plane is the screen, the origin is the center of the screen, and the <code>z</code> axis points out of the screen, toward the viewer. <li><b>Focal coordinates.</b> The camera coordinates translated to put the origin at the focal point, which is set back from the screen by the focal distance.</li> </ul> The <code>boxToCam</code> transformation is exposed to help 3D elements manage their 2D representations in central projection mode. To map world coordinates to focal coordinates, use the {@link JXG.View3D#worldToFocal} method. */
    boxToCam: number[];
...
export interface Circle extends Omit<GeometryElement, 'addTransform'> {
    ...
    line: Line;
    /** Stores the given method. Can be &lt;ul&gt;&lt;li&gt;&lt;b&gt;&#039;twoPoints&#039;&lt;/b&gt; which means the circle is defined by its center and a point on the circle.&lt;/li&gt; &lt;li&gt;&lt;b&gt;&#039;pointRadius&#039;&lt;/b&gt; which means the circle is defined by its center and its radius given in user units or as term.&lt;/li&gt; &lt;li&gt;&lt;b&gt;&#039;pointLine&#039;&lt;/b&gt; which means the circle is defined by its center and its radius given by the distance from the startpoint and the endpoint of the line.&lt;/li&gt; &lt;li&gt;&lt;b&gt;&#039;pointCircle&#039;&lt;/b&gt; which means the circle is defined by its center and its radius given by the radius of another circle.&lt;/li&gt;&lt;/ul&gt; */
    method: string;
...
export interface Curve extends Omit<GeometryElement, 'addTransform'> {
    /** Array holding the x-coordinates of a data plot. This array can be updated during run time by overwriting the method {@link JXG.Curve#updateDataArray}. */
    dataX: number[];
    /** Array holding the y-coordinates of a data plot. This array can be updated during run time by overwriting the method {@link JXG.Curve#updateDataArray}. */
    dataY: number[];
    /** Number of points on curves. This value changes between numberPointsLow and numberPointsHigh. It is set in {@link JXG.Curve#updateCurve}. */
    numberPoints: number;
...
export interface Group extends Composition {
    /** Cache coordinates of points. From this and the actual position of the points, the translation is determined. It has to be kept updated in this class  */
    coords: Object;
...
export interface Line3D extends GeometryElement3D {
    ...
    endpoints: number[];
    /** Spanning vector of the 3D line. Contains the evaluated coordinates from {@link direction} and {@link range}. The array has length 4, the first entry being 0. */
    vec: number[];
...
export interface Plane3D extends GeometryElement3D {
    ...
    point: Point3D;
    /** Spanning vector 1 of the 3D plane. Contains the evaluated coordinates from {@link direction1} and {@link range1}. and is of length 4, the first entry being 0, i.e. homogenous coordinates. */
    vec1: number[];
    /** Spanning vector 2 of the 3D plane. Contains the evaluated coordinates from {@link Plane3D#direction2} and {@link Plane3D#range2} and is of length 4, the first entry being 0, i.e. homogenous coordinates. */
    vec2: number[];
...
export interface Polygon3D extends GeometryElement3D {
    /** References to the points defining the polygon. Compared to the 2D {@link JXG.Polygon#vertices}, it contains one point less, i.e. for a quadrangle 'vertices' contains four points. In a 2D quadrangle, 'vertices' will contain five points, the last one being a copy of the first one. */
    vertices: number[][];
...
export interface Angle extends Sector {
    /** The point defining the radius of the angle element. Alias for {@link Sector#radiuspoint}. */
    point: Point;
...
export interface Button extends Text, Omit<CoordsElement, 'setPosition' | 'setPositionDirectly' | 'update' | 'snapToPoints'>, Omit<GeometryElement, 'setPositionDirectly' | 'snapToPoints' | 'setPosition' | 'update'> {
    /** The HTML element for this button */
...
export interface Checkbox extends Text, Omit<CoordsElement, 'setPosition' | 'setPositionDirectly' | 'update' | 'snapToPoints'>, Omit<GeometryElement, 'setPositionDirectly' | 'snapToPoints' | 'setPosition' | 'update'> {
    /** The HTML element for this checkbox */
...
export interface Parallelogram extends Polygon {
    /** Parallel point which makes the quadrilateral a parallelogram. Can also be accessed with parallelogram.vertices[2]. */
    parallelPoint: Point;
...
export interface Sphere3D extends GeometryElement3D {
    ...
    element2D: GeometryElement;
    /** The construction method. Can be: <ul><li><b><code>'twoPoints'</code></b> &ndash; The sphere is defined by its center and a point on the sphere.</li> <li><b><code>'pointRadius'</code></b> &ndash; The sphere is defined by its center and its radius in user units.</li></ul> */
    method: string;
...
export declare class TSXBoard {
   ...
   *```
    ...
    Glider3D(element: Curve3D | Line3D | Sphere3D, initial?: NumberFunction[], attributes?: Glider3DAttributes): Point3D;
