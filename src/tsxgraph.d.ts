export declare namespace TSX {
    ...
    export type pointAddr3D = NumberFunction[] | [number | Function, number | Function, number | Function];
   ...
   *``` */
   ...
   ~~~             */
    ...
    export class ParametricSurface3D extends Curve3D {
        /**  */
        addTransform(other: ParametricSurface3D, transforms: Transform3D[]): any;
    }
